      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white/80 text-gray-500">{t('newToPlatform')}</span>
            </div>
          </div>
          ...
          <Link
            to="/register"
            className="w-full flex justify-center py-3 px-4 border border-gray-200 rounded-xl text-gray-700 bg-white/50 backdrop-blur-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transform hover:scale-[1.02] transition-all duration-200 font-semibold"
          >
            {t('createNewAccount')}
          </Link>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-500">
            {t('termsAgreement')}{' '}
            <a href="#" className="text-indigo-600 hover:text-indigo-500 font-medium">{t('termsOfService')}</a>
            {' '}{t('and')}{' '}
            <a href="#" className="text-indigo-600 hover:text-indigo-500 font-medium">{t('privacyPolicy')}</a>
          </p>
        </div>
      </div>
    </div>
